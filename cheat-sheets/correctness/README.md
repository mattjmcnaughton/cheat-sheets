...
| [State](state/README.md) | What the program holds and how it changes | 8 sheets |
| [Contracts](contracts/README.md) | What a caller is promised | 6 sheets |
| [Change](change/README.md) | Behavior drifting from expectation over time | 5 sheets |
| [Execution](execution/README.md) | Reaching a usable result within operating limits | 5 sheets |

The five sections separate along how the failure hides:
...
**Execution** can look correct on a small, convenient input while failing to
finish, retain bounded state, or produce an accurate result on the supported
workload. Its hidden assumptions concern progress, input growth, chunking, and
numerical error.
